...
class AddEditTaskViewModel(
    ...
    private val _taskUpdatedEvent = MutableLiveData<Event<Task>>()
    val taskUpdatedEvent: LiveData<Event<Task>> = _taskUpdatedEvent
    ...
    private fun createTask(newTask: Task) = viewModelScope.launch {
        ...
        _taskUpdatedEvent.value = Event(newTask)
    }
    ...
    private fun updateTask(task: Task) {
        ...
        viewModelScope.launch {
            saveUseCase(task)
            _taskUpdatedEvent.value = Event(task)
        }
    }
}
